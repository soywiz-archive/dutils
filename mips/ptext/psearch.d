...
const char[] _VERSION_ = "3.2.0-beta";
...
void showusage() {
	...
	writeln(
		...
		"    OV_PDVD_BTL_US.OVL:100-200:64B880\n"
		"      will load 512 bytes starting by 256 of OV_PDVD_BTL_US.OVL at adress 64B880\n"
		"\n"
		"<mapfile>: \n"
		"  mapfile is a file with several maps in separated lines\n"
		"\n"
		"<pointer_file>: \n"
		"  a pointer file is a list of pointers in separated lines\n"
		"\n"
		"Examples: \n"
				...
				switch (cp[1..cp.length]) {
					...
					case "pf":
						...
						while (!f.eof) {
							...
							SEARCH_INFO si;
							si.start = hexdec(line) & ~0x_80_00_00_00;
							search[si.start] = si;
						}
						f.close();
						n += 1;
